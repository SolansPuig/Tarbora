        ...
        nodes = {
            {
                name = "arm_l",
                scale = 1.00,
                position = {46.50, 26.70, 0.00},
                rotation = {-20.00, -50.00, -80.00},
                size = {32.50, 20.00, 20.00},
                shape = "cube_mirror.mesh",
                uv_map = {88, 85},
                color_primary = {103, 255, 0},
                nodes = {
                    {
                        name = "forearm_l",
                        scale = 1.00,
            ...
            },
            {
                name = "arm_r",
                scale = 1.00,
                position = {-46.50, 45.70, 0.00},
                rotation = {0.00, -0.00, 80.00},
                size = {32.50, 20.00, 20.00},
                shape = "cube.mesh",
                uv_map = {88, 85},
                color_secondary = {77, 11, 11},
                nodes = {
                    {
                        name = "forearm_r",
                        scale = 1.00,
