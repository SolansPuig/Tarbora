...
namespace Tarbora {
    ...
    public:
        ...
        static T get(const LuaTable *table, const std::string &name, const T &def, bool silent);
        ...
        static T as(sol::state *state, const sol_object &object, const std::string &name, const T &def, bool silent);
    };
    ...
    public:
        LuaObject() {}
        LuaObject(sol::state *state, const sol_object &obj, const std::string &name)
        ...
        template <class T>
        bool is() const { return LuaType<T>::is(object_) || LuaType<LuaFunction<T>>::is(object_); }
    ...
    public:
        LuaTable() {}
        LuaTable(sol::state *state, const sol::table &table, const std::string &name)
        ...
        template <class T>
        LuaTable& set(const std::string &name, const T &value) { return LuaType<T>::set(this, name, value); }
        template <class T>
        LuaTable& set(unsigned int index, const T &value) { return LuaType<T>::set(this, index, value); }
    ...
    public:
        ...
        static LuaFunction<T> get(const LuaTable *table, const std::string &name, const LuaFunction<T> &def, bool silent)
        {
            if (table->table_)
        ...
        static LuaFunction<T> get(const LuaTable *table, unsigned int index, const LuaFunction<T> &def, bool silent)
        {
            if (table->table_)
                return as(table->lua_, table->table_[index], table->name_ + std::to_string(index), def, silent);
            return def;
        }

        static bool is(const sol_object &object) { return object.is<sol::protected_function>(); }

        static LuaFunction<T> as(sol::state *state, const sol_object &object, const std::string &name, const LuaFunction<T> &def, bool silent)
        {
    ...
    template <class T>
    T LuaType<T>::get(const LuaTable *table, const std::string &name, const T &def, bool silent)
    {
        if (table->table_)
            return as(table->lua_, table->table_[name], table->name_ + name, def, silent);
        return def;
    ...
    template <class T>
    T LuaType<T>::as(sol::state *state, const sol_object &object, const std::string &name, const T &def, bool silent)
    {
        if (object.is<T>())
            return object.as<T>();
    ...
    template <>
    inline LuaTable& LuaType<LuaTable>::set(LuaTable *table, const std::string &name, const LuaTable &value)
    {
        if (table->table_)
    ...
    template <>
    inline LuaTable& LuaType<LuaTable>::set(LuaTable *table, unsigned int index, const LuaTable &value)
    {
        if (table->table_)
    ...
    template <>
    inline LuaTable LuaType<LuaTable>::as(sol::state *state, const sol_object &object, const std::string &name, const LuaTable &def, bool silent)
    {
    ...
    template <>
    inline LuaTable& LuaType<glm::vec3>::set(LuaTable *table, const std::string &name, const glm::vec3 &value)
    {
        if (table->table_)
        {
    ...
    template <>
    inline LuaTable& LuaType<glm::vec3>::set(LuaTable *table, unsigned int index, const glm::vec3 &value)
    {
        if (table->table_)
        {
    ...
    template <>
    inline LuaTable& LuaType<glm::vec4>::set(LuaTable *table, const std::string &name, const glm::vec4 &value)
    {
        if (table->table_)
        {
            LuaTable t = table->createTable(name);
    ...
    template <>
    inline LuaTable& LuaType<glm::vec4>::set(LuaTable *table, unsigned int index, const glm::vec4 &value)
    {
        if (table->table_)
        {
            LuaTable t = table->createTable(index);
    ...
    template <>
    inline glm::vec3 LuaType<glm::vec3>::as(sol::state *state, const sol_object &object, const std::string &name, const glm::vec3 &def, bool silent)
    {
    ...
    template <>
    inline glm::vec4 LuaType<glm::vec4>::as(sol::state *state, const sol_object &object, const std::string &name, const glm::vec4 &def, bool silent)
    {
        LuaTable table = LuaType<LuaTable>::as(state, object, name, LuaTable(), silent);
        glm::vec4 vec;
        for (int i = 0; i < 4; i++)
    ...
    template <>
    inline LuaObject LuaType<LuaObject>::as(sol::state *state, const sol_object &object, const std::string &name, const LuaObject &def, bool silent)
    {
        UNUSED(def);
        UNUSED(silent);
    ...
    public:
        ...
        static std::vector<T> get(const LuaTable *table, const std::string &name, const std::vector<T> &def, bool silent)
        {
            if (table->table_)
            {
                return as(table->lua_, table->table_[name], table->name_ + name, def, silent);
        ...
        static std::vector<T> get(const LuaTable *table, unsigned int index, const std::vector<T> &def, bool silent)
        {
            if (table->table_)
            {
                return as(table->lua_, table->table_[index], table->name_ + std::to_string(index), def, silent);
        ...
        static std::vector<T> as(sol::state *state, const sol_object &object, const std::string &name, const std::vector<T> &def, bool silent)
        {
