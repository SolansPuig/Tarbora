...
namespace Tarbora {
  ...
  public:
    //! Constructor
    /*!
      \param id This will be the id used by the MessageManager. This module will be
    ...
    */
    ...
    /*!
      When this function is overrided in a child module, it will be called at the
      begginnig of each iteration.
    */
    virtual void getInput() {}

    //! Perform the logic and the computations of the module.
    /*!
      This function must be overrided in every child module, it will be called after
      Module::getInput at each iteration.
    ...
    */
    ...
    /*!
      When this function is overrided in a child module, it will be called at the end of
      each iteration.
    */
    virtual void draw() {}
